        ...
        return (
            <div>
                ...
                <Dialog open={this.state.dialog} onClose={this.handleDialogToggle}>
                    ...
                    <DialogContent>
                        <TextField label="textName" name="textName" value={this.state.textName} onChange={this.handleValueChange} />
                        <input className={classes.hidden} accept="text/plain" id="raised-button-file" type="file" file={this.state.fileName} value={this.state.fileName} onChange={this.handleFileChange} />
                        <br />
                        <br />
